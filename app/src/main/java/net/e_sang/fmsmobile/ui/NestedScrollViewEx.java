...
public class NestedScrollViewEx extends FrameLayout implements NestedScrollingParent,
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(NestedScrollViewEx v, int scrollX, int scrollY,
...
//                mIsBeingDragged = !mScroller.isFinished();
                mIsBeingDragged = false;        // 20180622 백현재 수정: fling시 child에 touch 전달되도록...
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final NestedScrollViewEx nsvHost = (NestedScrollViewEx) host;
